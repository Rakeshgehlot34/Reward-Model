    ...
    def handle(self, handler_input):
        ...
        if profession == 'student':
            ...
            if student_pass==password:
                ...
                speak_output = "Please check your loginID or password."
            ...
            speak_output = "invalid Information"
        return (
            handler_input.response_builder
                .speak(speak_output)
                .ask(speak_output)
...
class ViewPointHandler(AbstractRequestHandler):
    """Handler for View Point"""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("ViewPoint")(handler_input)
...
sb.add_request_handler(ViewPointHandler())
